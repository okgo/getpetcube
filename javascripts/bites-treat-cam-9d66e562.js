...
(function() {
  (function($, window, document) {
    $(window).load(function() {
      return $(".preload").addClass("loaded");
    });
    $("#viewpartners").click(function(e) {
      e.preventDefault();
      $(".partners-container").slideToggle("slow");
      return $(".contacts-container").hide();
    });
    return $("#viewcontacts").click(function(e) {
      e.preventDefault();
      $(".contacts-container").slideToggle("slow");
      return $(".partners-container").hide();
    });
  })(jQuery, window, document);
...
(function() {
  ...
  startScroll = function() {
    var scene_1, scene_10, scene_11, scene_12, scene_13, scene_2, scene_3, scene_4, scene_5, scene_6, scene_7, scene_8, scene_9, tween_10, tween_11, tween_12, tween_13, tween_7, tween_8, tween_9;
    ...
    scene_4 = new ScrollMagic.Scene({
      triggerElement: '#sec3',
      duration: $('#sec3').height()
    }).setClassToggle('#cur3', 'current').addTo($controller);
    scene_5 = new ScrollMagic.Scene({
      triggerElement: '#sec4',
      duration: $('#sec4').height()
    }).setClassToggle('#cur4', 'current').addTo($controller);
    scene_6 = new ScrollMagic.Scene({
      triggerElement: '#sec5',
      duration: $('#sec5').height() * 1.8
    }).setClassToggle('#cur5', 'current').addTo($controller);
    tween_7 = new TimelineMax().fromTo("#sec1 img", 1, {
      opacity: 0
    }, {
      opacity: 1
    }).fromTo("#sec1 .reviews-list", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    tween_8 = new TimelineMax().fromTo("#sec2 img", 1, {
      ...
      opacity: 1
    }).fromTo("#sec2 .testimonials-list", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    tween_12 = new TimelineMax().fromTo(".images-section .h1", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
      opacity: 1
    }).fromTo(".images-section p", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    scene_12 = new ScrollMagic.Scene({
      triggerElement: '.images-section',
      reverse: false
    }).setTween(tween_12).addTo($controller);
    tween_13 = new TimelineMax().fromTo(".two-better-than-one .text-block", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    return scene_13 = new ScrollMagic.Scene({
      triggerElement: '.two-better-than-one',
      reverse: false
    }).setTween(tween_13).addTo($controller);
  };

  $controller.scrollTo(function(target) {
    return TweenMax.to(window, 0.5, {
      scrollTo: {
        y: target - $('.header-menu').outerHeight(),
        autoKill: true
      }
    });
  });
  ...
  $(window).on('load', function() {
    ...
    if (currentSlide !== 0) {
      ...
      return $counterContainer.html('<span>' + '0' + '1' + '</span>' + '/' + '0' + '5');
    }
  });
